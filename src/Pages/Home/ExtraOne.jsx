...
const ExtraOne = () => {
    ...
    <div className='flex flex-col  lg:flex-row'>
        <motion.div className=' w-11/12 lg:w-3/12  box mx-auto bg-blue-300 dark:bg-cyan-700 my-10 rounded-3xl'
        whileHover={{ scale: [null, 1.5, 1.4] }}
        transition={{ duration: 0.3 }}
        >
            <div className=' p-12 text-black dark:text-white flex flex-col gap-5 '>
                ...
                <button className='btn  bg-cyan-300 text-lg font-bold border-cyan-500 rounded-3xl'>Login/Register</button>
            </div>
        </motion.div>
        <motion.div className=' w-11/12 lg:w-3/12   box mx-auto  bg-blue-300 dark:bg-cyan-700 my-10 rounded-3xl'
        whileHover={{ scale: [null, 1.5, 1.4] }}
        ...
        >
            <div className=' p-12 text-black   dark:text-white flex flex-col gap-5 '>
                ...
                <button className='btn  bg-cyan-300 text-lg font-bold border-cyan-500 rounded-3xl'>Explore</button>
            </div>
        </motion.div>
        <motion.div className=' w-11/12 lg:w-3/12  box mx-auto bg-blue-300 dark:bg-cyan-700 my-10 rounded-3xl'
        whileHover={{ scale: [null, 1.5, 1.4] }}
        ...
        >
            <div className=' p-12 text-black dark:text-white  flex flex-col gap-5 '>
                ...
                <button  className='btn  bg-cyan-300 text-lg font-bold border-cyan-500 rounded-3xl cursor-pointer'>Connect</button>
            </div>
        </motion.div>
